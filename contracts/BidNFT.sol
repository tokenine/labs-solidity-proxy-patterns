...
//     modifier onlySupportTokens(address tokenAddr) virtual {
...
//     function buyToken(uint256 _tokenId) external virtual override whenNotPaused {
...
//     ) external virtual override whenNotPaused onlySupportTokens(_quoteTokenAddr) {
//         require(
...
//         address _quoteTokenAddr,
//         address _to
//     ) public virtual override whenNotPaused onlySupportTokens(_quoteTokenAddr) {
//         require(
...
//     function cancelSellToken(uint256 _tokenId) external virtual override whenNotPaused {
//         require(
//             _userSellingTokens[_msgSender()].contains(_tokenId),
...
//     function cancelBidToken(uint256 _tokenId) external virtual override whenNotPaused {
...
//     function getAsks() external virtual view returns (AskHelper.AskEntry[] memory) {
//         return _asksMap.getAsks(_asksQuoteTokens);
//     }

//     function getAsksDesc() external virtual view returns (AskHelper.AskEntry[] memory) {
...
//     function getBidsLength(uint256 _tokenId) external virtual view returns (uint256) {
...
//     function addSupportedQuoteToken(address quoteTokenAddr) external virtual onlyOwner {
...
//     function transferFeeAddress(address _feeAddr) external virtual {
//         require(_msgSender() == feeAddr, "FORBIDDEN");
//         feeAddr = _feeAddr;
//         emit FeeAddressTransferred(_msgSender(), feeAddr, now);
//     }

//     function setFeePercent(uint256 _feePercent) external virtual onlyOwner {
